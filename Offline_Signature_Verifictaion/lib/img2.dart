...
class Imageupload2 extends StatefulWidget{
  @override
  _Imageuploadstate2 createState()=>_Imageuploadstate2();
}
  
class _Imageuploadstate2 extends State<Imageupload2> {
File _img;
  File _cam;
  bool uploaded=false;
 ...
 bool _autoValidate = false;
  ...
  Widget build(BuildContext context){
    ...
    var uid = user.uid;
       if(_img!=null){
       StorageReference firebaseStorageRef = FirebaseStorage.instance.ref().child('$uid').child('IMG2');
...
Future getdata() async{
    ...
    final FirebaseUser user = await _auth.currentUser();
    var uid = user.uid;
    var ref=FirebaseStorage.instance.ref().child('$uid').child('IMG2');
...
// print(url);
// ref.child('leafdisease').once().then((value){
// var data=value.value;
// var key=value.value.keys;
// for(var i in key){
//  var x=data[i];
//  _showDialog1("The disease is $x");
// }
// }
